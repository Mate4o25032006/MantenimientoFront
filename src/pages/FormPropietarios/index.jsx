...
export const FormPropietarios = () => {
    const initialData = {documento : "", nombre : "", dependencia : "", departamento: ""};
    ...
    const handleSubmit = usePostData("propietarios", onSubmit, inputs);

    return (
        <Forms>
            <h1 className="text-center my-2 mb-8 text-xl font-semibold">Formulario Propietarios</h1>
