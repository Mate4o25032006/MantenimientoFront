...
export function GestionMantenimiento() {
  const [equipos, setEquipos] = useState([
    ...
    },
    {
      ...
      hostname: "router01",
      estado: "En uso",
      ultimoMantenimiento: "2023-03-01",
      proximoMantenimiento: "2023-09-01",
      propietario: "Sarah Lee",
    ...
    },
    {
      ...
      proximoMantenimiento: "2023-10-20",
      propietario: "David Kim",
      responsable: "Emily Chen",
      observaciones: "",
    },
  ])
  ...
  const filteredEquipos = equipos.filter((equipo) => equipo.nombre.toLowerCase().includes(busqueda.toLowerCase()))
  return (
            ...
            {filteredEquipos.map((equipo) => (
              <div
                ...
                className={`bg-card text-card-foreground rounded-lg p-4 cursor-pointer transition-colors hover:bg-muted ${
                  equipoSeleccionado?.id === equipo.id ? "bg-muted" : ""
                }`}
